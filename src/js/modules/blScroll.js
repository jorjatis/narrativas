export default function blScroll() {
  ...
  // Constantes
  const navLis = document.querySelectorAll('.bl-nav ul li');
  ...
  let activeLi = 0;
    ...
    const elements = {
        0: { 
            imgFile: 'https://s3.abcstatics.com/comun/especiales/bandas-latinas/media/ABC_ParaQueLlore_06.jpg',
            title: 'Prólogo',
        ...
        1: {
            imgFile: 'https://s3.abcstatics.com/comun/especiales/bandas-latinas/media/ABC_ParaQueLlore_01.jpg',
            title: 'Episodio 1',
        ...
        2: {
            imgFile: 'https://s3.abcstatics.com/comun/especiales/bandas-latinas/media/ABC_ParaQueLlore_02.jpg',
            title: 'Episodio 2',
        ...
        3: {
            imgFile: 'https://s3.abcstatics.com/comun/especiales/bandas-latinas/media/ABC_ParaQueLlore_03.jpg',
            title: 'Episodio 3',
        ...
        4: {
            imgFile: 'https://s3.abcstatics.com/comun/especiales/bandas-latinas/media/ABC_ParaQueLlore_04.jpg',
            title: 'Episodio 4',
        ...
        5: {
            imgFile: 'https://s3.abcstatics.com/comun/especiales/bandas-latinas/media/ABC_ParaQueLlore_05.jpg',
            title: 'Episodio 5',
  ...
  ScrollTrigger.create({
    ...
    start: "bottom top+=58",
    onEnter: () => {
      document.querySelector('.bl-nav')?.classList.add('bl-b');
    },
    onLeaveBack: () => {
      document.querySelector('.bl-nav')?.classList.remove('bl-b');
    }
  });

  ScrollTrigger.create({
    trigger: ".v-a--d-s-1",          // contenedor principal
    start: "top center",              // cuando la parte superior del trigger llega al centro de la pantalla
    onEnter: () => {
      document.querySelector('.v-a--d-s-1 .v-a-img-c')?.classList.add('mover');
    },
    markers: true
  });
