...
export default function animateGaviotaOver() {
  ...
  const gaviotaImg = document.querySelector(".gaviota-over img");
  ...
  const getValues = () => {
    const gaviotaWidth = gaviotaImg.offsetWidth;
    const gaviotaHeight = gaviotaImg.offsetHeight;
    const distanceX = gaviotaWidth;
    const distanceY = gaviotaHeight;
