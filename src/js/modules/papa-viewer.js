...
const POPE_ITEMS = [
  {
    ...
    label: 'Sotana',
    colors: ['blanco'],
    simbolismo: 'Pureza, santidad y la alegría de la Resurrección. 33 Botones, los años de Cristo.',
    ...
    thumbImg: '<svg xmlns="http://www.w3.org/2000/svg" id="Capa_2" viewBox="0 0 600 600"><defs><style>.cls-1{fill:none;stroke:#0e3a6f;stroke-linecap:round;stroke-linejoin:round;stroke-width:8px}.cls-2{fill:#0e3a6f;stroke-width:0}</style></defs><g id="ICONOS"><path d="M317 30h43v30H240V30h43v15.62h34zM360 60l60 30 60 90v150h-60v225l-120-19.63L180 555V330h-60V180l60-90 60-30" class="cls-1"/><path d="m180 555 120 15 120-15-120-19.63zM300 60v475.37M180 346.63V180M420 345V180" class="cls-1"/><path d="M312.26 501.95h8.05V510h-8.05zM312.26 462.28h8.05v8.05h-8.05zM312.26 422.6h8.05v8.05h-8.05zM312.26 382.93h8.05v8.05h-8.05zM312.26 343.26h8.05v8.05h-8.05zM312.26 303.59h8.05v8.05h-8.05zM312.26 263.91h8.05v8.05h-8.05zM312.26 224.24h8.05v8.05h-8.05zM312.26 184.57h8.05v8.05h-8.05zM312.26 144.89h8.05v8.05h-8.05zM312.26 105.22h8.05v8.05h-8.05zM312.26 65.55h8.05v8.05h-8.05z" class="cls-2"/></g></svg>',
...

  {
    ...
    uso: 'Pequeño gorro de seda redondo que cubre la coronilla. Se lleva bajo de la mitra. Uso permanente: vida cotidiana, audiencias y ceremonias.',
...

  {
    ...
    uso: 'Anillo oficial del Pontífice colocado en el dedo anular de la mano derecha. Se deforma con un martillo tras su muerte o renuncia. Lleva el de oro en ceremonias y eventos solemnes.',
...

  {
    ...
    uso: 'Cruz que cuelga sobre el pecho mediante un cordón (oro y rojo en la liturgia) o una cadena (en el día a día). Uso continuo tanto en la vida cotidiana como en audiencias y todas las funciones litúrgicas.',
